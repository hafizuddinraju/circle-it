...
import { SiGnuprivacyguard, SiTeradata } from "react-icons/si";
...
const Signup = () => {
  const {createUser, userProfile,setSign,gitHubLogin, googleLogin} = useContext(AuthDataContext);
  ...
  const handleSubmit =(event)=>{
    ...
    .then(result =>{
     ...
     updateProfile(name, photoURL)
      toast.success('Account create Success', {autoClose:500})
      form.reset();
      navigate('/')
